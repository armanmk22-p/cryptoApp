...
class _CoinListScreenState extends State<CoinListScreen> {
          ...
          child: Column(
            children: [
              Padding(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                      ...
                      hintStyle: TextStyle(fontFamily: 'mr', color: Colors.white,fontStyle: FontStyle.italic),
              ...
              Visibility(
                ...
                child: Text(
                  'data is loading ...',
                  style: TextStyle(color: greenColor, fontFamily: 'mr',fontStyle: FontStyle.italic),
                ),
              ),
              Expanded(
                child: RefreshIndicator(
                  ...
                  color: blackColor,
                  onRefresh: () async {
                    List<CryptoModel> fereshData = await _getData();
                    setState(() {
  ...
  Widget _getListTileItem(CryptoModel crypto) {
    return ListTile(
      title: Text(
        crypto.name,
